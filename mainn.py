...
lr_accuracy = clf.score(X_test, y_test_cls) * 100

print('OneVsRest Logistic Regression accuracy: ' + str(lr_accuracy))
...
dt_acc = accuracy_score(y_test_cls, y_pred) * 100
...
rfc_acc = accuracy_score(y_test_cls, p) * 100
...
accuracy_ens = accuracy_score(y_test_cls, predict_test) * 100
print('\naccuracy_score on test dataset : ', accuracy_ens)
...
svm_acc = accuracy_score(p, y_test_cls) * 100
print(accuracy_score(p, y_test_cls))

x_c = ['Logistic Regression', 'Decision Tree', 'Random Forest Classifier', 'Gradient Boost Classifier', 'SVM']
to_plot = [lr_time, dt_tr_time, rfc_tr_time, end_tr_time, svm_tr_time]
plt.bar(x_c, to_plot)
plt.xlabel('Bars')
plt.ylabel('Values')
...
x_c = ['Decision Tree', 'Random Forest Classifier', 'Gradient Boost Classifier', 'SVM']
to_plot = [dt_tst_time, rfc_tst_time, end_tst_time, svm_tst_time]
plt.bar(x_c, to_plot)
plt.xlabel('Bars')
plt.ylabel('Values')
plt.title('Bar Plot Example')
...
x_c = ['Logistic Regression', 'Decision Tree', 'Random Forest Classifier', 'Gradient Boost Classifier', 'SVM']
to_plot = [lr_accuracy, dt_acc, rfc_acc, accuracy_ens, svm_acc]
plt.bar(x_c, to_plot)
plt.xlabel('Bars')
plt.ylabel('Values')
plt.title('Bar Plot Example')
